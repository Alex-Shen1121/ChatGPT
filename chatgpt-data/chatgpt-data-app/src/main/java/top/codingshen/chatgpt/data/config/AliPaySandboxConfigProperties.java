...
/**
 * @ClassName AliPaySandboxConfigProperties
 * @Description 支付宝沙箱支付 配置信息
 * @Author alex_shen
 * @Date 2024/1/13 - 15:26
 */
@Data
@ConfigurationProperties(prefix = "alipay.sandbox.config", ignoreInvalidFields = true)
public class AliPaySandboxConfigProperties {
    /** 状态；open = 开启、close 关闭 */
